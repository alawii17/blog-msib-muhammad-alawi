...
@endif
        ...
        <form action="{{ route('authors.store') }}" method="POST" class="mt-5" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">JPEG, PNG, JPG or GIF (MAX.
                    800x400px).</p>
            </div>
