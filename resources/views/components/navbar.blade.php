                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        @auth
                            ...
                            <x-nav-link href="{{ route('categories.index') }}" :active="request()->is('categories')">Category</x-nav-link>
                            <x-nav-link href="{{ route('authors.index') }}" :active="request()->is('authors')">Author</x-nav-link>
                        @endauth
                    </div>
                </div>
            </div>
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button type="button" @click="isOpen = !isOpen"
                                        ...
                                        alt="{{ Auth::user()->name }}"
                                        x-show="!{{ Auth::user()->image ? 'false' : 'true'}}">
                                        <svg x-show="{{ Auth::user()->image ? 'false' : 'true' }}" class="w-10 h-10 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                                    ...
                                    <a href="{{ route('profile', Auth::user()->id) }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem"
