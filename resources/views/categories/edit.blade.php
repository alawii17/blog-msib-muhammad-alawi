<x-layout>
    ...
    <div class="container mx-auto p-6">
        ...
        <form class="mt-5" action="{{ route('categories.update', $category->slug) }}" method="POST">
            ...
            <button type="submit" class="w-full bg-yellow-400 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Update Category</button>
        </form>
    </div>
</x-layout>
