<x-layout>
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mt-12 mx-auto lg:py-0">
        @if ($errors->any())
    ...
    @endif
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 my-5 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="{{ route('password.update') }}" method="POST" id="reset-password-form">
                    @csrf
