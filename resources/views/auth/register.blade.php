<x-layout>
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mt-12 mx-auto md:h-screen lg:py-0">
        @if ($errors->any())
            ...
            style="position: absolute; top: 1rem; right: 1rem; z-index: 50;" role="alert">
                ...
                <button type="button" class="absolute top-0 right-0 p-2" onclick="document.getElementById('alert').style.display='none'">
                    <span class="text-xl font-bold text-red-700">&times;</span>
                </button>
            </div>
        @endif
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 my-5 dark:bg-gray-800 dark:border-gray-700">
